...
namespace VTACheckClock.Views
{
    ...
    partial class MainWindow : ReactiveWindow<MainWindowViewModel> /*Window*/
    {
        ...
        private static void SetParentWindow()
        {
            ...
            // Obtiene la pantalla en la que se encuentra la posici�n del mouse.
            //Screen screen = Screens.ScreenFromPoint(new PixelPoint(mouseX, mouseY));

            // Establece la posici�n de la ventana en la pantalla en la que se encuentra el mouse.
        ...
        /// <summary>
        /// Intercepta el evento de presionar y soltar una tecla y decide la acci�n a realizar.
        /// <para>
        /// - F11: Alterna el modo de pantalla completa.
        /// </para>
        /// <para>
        /// - Shift + F12: Invoca el cuadro de di�logo para efectuar el registro de asistencia con clave.
        /// </para>
        /// </summary>
